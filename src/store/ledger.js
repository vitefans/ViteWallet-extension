...
const mutations = {
    ...
    setTokenInfo(state, { tokenInfo, tokenId }) {
        ...
        const tokenId2 = tokenId || tokenInfo.tokenId;
        state.tokenInfoMaps[tokenId2] = tokenInfo;
        state.tokenInfoMaps[tokenId2].tokenId = tokenId2;
        if (state.defaultTokenIds[tokenId2]) {
            state.tokenInfoMaps[tokenId2].icon = state.defaultTokenIds[tokenId2].icon;
        }
    }
};
